...
# scan2graph vendor note: the real checkov json_utils.py also special-cases
# Severity/ImageDetails/MatchMetadata/DataFlow/MatchLocation/Point/
# PotentialSecret -- types from checkov's severity/output/SAST/secret-
# detection subsystems, none of which graph-building ever produces. Rather
# than pull those subsystems in just for isinstance() branches that can
# never match on our code path, these are unreachable sentinel classes: no
# real object is ever an instance of them, so the branches below become dead
# code (correct no-ops), not silently-wrong behavior.
class Severity:  # noqa: N801
    pass


class ImageDetails:  # noqa: N801
    pass


class MatchMetadata:  # noqa: N801
    pass


class DataFlow:  # noqa: N801
    pass


class MatchLocation:  # noqa: N801
    pass
...
class PotentialSecret:  # noqa: N801
    pass
